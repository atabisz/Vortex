...
const SHIM_PATH = path.resolve(import.meta.dirname, "../../src/renderer/src/util/winapi-shim.ts");

const linuxAlias = process.platform === "linux" ? { "winapi-bindings": SHIM_PATH } : undefined;
