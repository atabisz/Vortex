...
- [x] **SYNC-39b**: R1 dead-code carry-forward — confirm v8.1's Wave-1 `DownloadManager`/`DownloadObserver` deletion remains intact (no upstream resurrection of the dead modules) — Phase 39
