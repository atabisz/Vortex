...
- [x] **Phase 6: Steam/Proton Detection** — Validate and complete Steam/Proton game detection on Linux; fix `{mygames}` Wine prefix path; audit top-4 game extensions (completed 2026-04-01)
