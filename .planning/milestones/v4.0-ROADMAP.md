...
- ✅ **v4.0 Elevation Hardening + Save Transfer** — Phases 11–14 (shipped 2026-04-07)
...
- [x] **Phase 13: Save Transfer** — Profile-to-profile save file copy between Wine prefix paths (completed 2026-04-07)
...
**Plans:** 1/1 plans complete
Plans:
- [x] 13-01-PLAN.md — Extend fs.ts case-folding to copy/rename/ensureDir + empty-state transfer UX
