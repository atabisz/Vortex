...
- `1e8d0c756` fix(phase-34): G4 typecheck — strict-TS Rule 1 auto-fix - `vortex-app.ts:207` waitForFunction arrow → string form. **Rule 1**:
  ...
  that mis-classification. - `game-management.spec.ts:27` `GAME_CONFIGS.stardewvalley` → `!`
