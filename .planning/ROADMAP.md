...
- [ ] **Phase 25: Restore dropped scaffolding** — bring back `packages/paths`, `paths-node`, `gamebryo-ba2-support`, chunking; deliberately drop Jest scaffolding
...
| 25. Restore dropped scaffolding | v8.0 | 0/0 | Not started | - |
