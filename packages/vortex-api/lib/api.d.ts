...
declare const addExtension: reduxAct.ComplexActionCreator2<string, ExtensionInfo, {
    extensionId: string;
    info: ExtensionInfo;
}, {}>;
 ...
 * @public
 * */
declare type ApiEventArgs<TEvent extends ApiEventName> = Readonly<Parameters<ApiEvents[TEvent]>>;

/** Compat for NodeJS Event Map */
declare type ApiEventMap = {
 ...
 * @public
 * */
declare type ApiEventName = keyof ApiEvents;

/** Represents all event results.
 * @public
 * */
declare type ApiEventResult<TEvent extends ApiEventName> = ReturnType<ApiEvents[TEvent]>;
...
declare type ExtensionLoadFailureDependency = {
    id: "dependency";
    args: {
        dependencyId: string;
        version?: string;
...
declare type ExtensionLoadFailureException = {
    id: "exception";
    args: {
        message: string;
    };
 ...
 * @public
 * */
export declare type FileSystemErrorData = OsErrorData & {
    path: string;
};
 ...
 */
declare type HealthCheckFunction = (api: IExtensionApi, signal?: AbortSignal) => Promise<IHealthCheckResult>;
...
declare type IExtension = ExtensionInfo;
...
declare type IExtensionLoadFailure = {
...
declare const loadCategories: ComplexActionCreator2<string, ICategoryDictionary, {
gameId: string;
 ...
 * @public
 * */
export declare type OsErrorData = {
    originalCode: string;
    errno: number;
    syscall: string;
};
...
declare type PerModCheckFunction = (api: IExtensionApi, mod: IModCheckContext, signal?: AbortSignal) => Promise<IHealthCheckResult>;
...
declare const removeCategory: ComplexActionCreator2<string, string, {
gameId: string;
id: string;
}, {}>;
...
declare const renameCategory: ComplexActionCreator3<string, string, string, {
gameId: string;
categoryId: string;
name: string;
}, {}>;
...
declare const setCategory: ComplexActionCreator3<string, string, ICategory, {
gameId: string;
id: string;
category: ICategory;
}, {}>;

declare const setCategoryOrder: ComplexActionCreator2<string, string[], {
gameId: string;
categoryIds: string[];
}, {}>;
...
declare const setPickerLayout: ComplexActionCreator1<"small" | "list" | "large", {
...
declare const updateCategories: ComplexActionCreator2<string, ICategoryDictionary, {
gameId: string;
gameCategories: ICategoryDictionary;
}, {}>;
 ...
 * @public
 */
export declare class VortexError<out K extends VortexErrorKind = VortexErrorKind> extends Error {
 ...
 * @public
 */
export declare type VortexErrorData = { [K in VortexErrorKind]: {
        kind: K;
 ...
 * @public
 */
export declare type VortexErrorKind = keyof VortexErrorKindMap;
 ...
 * @public
 */
export declare interface VortexErrorKindMap {
...
declare function watch(filename: string, ...args: any[]): ReturnType<typeof watch_2>;
